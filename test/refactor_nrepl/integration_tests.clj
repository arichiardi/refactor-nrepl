...
(defmacro with-testproject-on-classpath
  "redef refactor-nrepl.core/dirs-on-classpath to point to testproject which is also made available as test-project-dir"
  [& body]
  `(with-redefs [refactor-nrepl.core/dirs-on-classpath (fn [] [(io/file "testproject")])]
     (let [~'test-project-dir "testproject"]
       ~@body)))
